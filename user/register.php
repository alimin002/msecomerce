...
<section class="main-content">				
	...
	<div class="control-group">
		...
		<div class="controls">
			<input type="text" name='kodepos' id='kodepos' value='<?php if(isset($data->kodepos)){echo $data->kodepos;}?>' class='required'>
		</div>
	</div>
	<div class="control-group">
		<label class="control-label" for="alamat">Alamat</label>
		<div class="controls">
			<textarea name='alamat' class="input-xlarge"><?php if(isset($data->alamat)){echo $data->alamat;}?></textarea>
		</div>
	</div>
	<div class="control-group">
		<div class="controls">
